...
Gem::Specification.new do |s|
  ...
  s.date = %q{2011-08-22}
  s.description = %q{A Ruby XMP reader library for extracting metadata from media files}
  ...
  s.summary = %q{A Ruby XMP reader library for extracting metadata from media files}
